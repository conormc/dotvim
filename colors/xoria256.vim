...
""" vimdiff {{{3
hi diffAdd      ctermfg=0  guifg=0      ctermbg=151 guibg=#afdfaf
"hi diffDelete   ctermfg=0  guifg=0      ctermbg=186 guibg=#dfdf87 cterm=0 gui=0
hi diffDelete   ctermfg=0  guifg=0      ctermbg=246 guibg=#949494 cterm=none gui=none
hi diffChange   ctermfg=0  guifg=0      ctermbg=181 guibg=#dfafaf
hi diffText     ctermfg=0  guifg=0      ctermbg=174 guibg=#df8787 cterm=none gui=none
""" HTML {{{3
